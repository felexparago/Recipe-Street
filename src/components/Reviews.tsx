        ...
        <div className="mt-16 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8">
          ...
          <form className="max-w-2xl mx-auto space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              />
              <select className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent">
            ...
            <div className="flex justify-center space-x-2 mb-4">
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                  <Star className="h-6 w-6 text-gray-300 hover:text-amber-500 hover:fill-current transition-all duration-200" />
                </button>
              ))}
            </div>
