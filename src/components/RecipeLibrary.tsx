  ...
  const RecipeCard = ({ recipe }: { recipe: any }) => (
    ...
    >
      ...
      <div className="p-4 sm:p-6">
        <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 group-hover:text-amber-600 transition-colors duration-300">
          {recipe.title}
        </h3>
        ...
        <button
          className="w-full bg-gray-900 text-white py-2 sm:py-3 rounded-lg hover:bg-amber-600 transition-all duration-300 font-semibold transform hover:scale-105 hover:shadow-lg active:scale-95 group text-sm sm:text-base"
    ...
    <>
      ...
      <section id="culinary-course" className="relative py-24 bg-gradient-to-br from-yellow-50 via-amber-100 to-orange-50 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <img src="https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Culinary Mastery" className="w-full h-full object-cover opacity-20" />
        </div>
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 flex flex-col items-center">
            <div className="relative w-full max-w-md rounded-3xl overflow-hidden shadow-2xl border-4 border-amber-400 bg-white">
              <img src="https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg?auto=compress&cs=tinysrgb&w=800" alt="Culinary Course" className="w-full h-80 object-cover" />
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-3xl w-full max-h-[95vh] overflow-hidden shadow-2xl relative flex flex-col md:flex-row">
            <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-amber-700 via-orange-500 to-yellow-400 relative">
              ...
              <div className="absolute inset-0 w-full h-full object-cover opacity-20 z-0" style={{ background: 'url(https://images.pexels.com/photos/262978/pexels-photo-262978.jpeg?auto=compress&cs=tinysrgb&w=800) center/cover no-repeat' }}></div>
            </div>
